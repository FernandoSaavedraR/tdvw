...
CREATE TABLE OFERTAS(
	ID_OFERTA INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
	TIPO_OF INT,
	FOREIGN KEY (TIPO_OF) REFERENCES TIPO_OFERTAS(ID_TO)
);
...
CREATE TABLE PEDIDOS(
	...
	ID_PASTELERO INT NOT NULL,
	ESTADO TEXT,
	FOREIGN KEY (ID_CLIENTE) REFERENCES USUARIO(ID_USUARIO),
	FOREIGN KEY (ID_PASTELERO) REFERENCES USUARIO(ID_USUARIO)
);
